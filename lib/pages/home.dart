...
final List<Menu> menus = [
  const Menu(Icons.home, "Home"),
  const Menu(Icons.multiline_chart, "Visualize"),
  const Menu(Icons.card_giftcard, "Reward"),
  const Menu(Icons.settings, "Settings"),
];
    ...
    return SingleChildScrollView(
      child: Column(
        children: [
          ...
          const ItemList(label: "New"),
          const ItemList(label: "Hot"),
        ],
      ),
    );
  }
